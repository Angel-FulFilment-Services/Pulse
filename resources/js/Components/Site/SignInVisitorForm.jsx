...
const steps = [
  ...
  { label: 'Visiting', key: 'visiting', placeholder: 'Who are you visiting?' },
  { label: 'Car Registration', key: 'carReg', placeholder: 'Enter your car registration (if applicable)' },
];

export default function SignInVisitorForm({ onComplete }) {
  const [step, setStep] = useState(0);
  const [form, setForm] = useState({ fullName: '', company: '', visiting: '', carReg: '' });
