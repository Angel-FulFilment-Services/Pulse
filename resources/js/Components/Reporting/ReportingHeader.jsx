                    ...
                    <div className="absolute top-[-0.200rem] right-[-0.200rem] w-2.5 h-2.5 rounded-full">
                      <PopoverFlyout
                        ...
                        content={
                          ...
                          <div className={`absolute w-2.5 h-2.5 rounded-full ${isPolling ? "bg-green-200" : "bg-red-200"}`}></div>
                          <button onClick={() => {handleTogglePolling()}} className={`absolute w-2.5 h-2.5 rounded-full ${isPolling ? "bg-green-500 animate-pulse" : "bg-red-400"} hover:grayscale-[50%] hover:animate-none cursor-pointer`}></button>
                        </PopoverFlyout>
                    </div>
                  }
              </>
