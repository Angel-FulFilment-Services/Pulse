        ...
        <Dialog as="div" className="relative z-30" onClose={handleClose}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex h-full items-center justify-center p-4 text-center sm:p-0 py-12 md:py-0">
              ...
              >
                <Dialog.Panel
                  className={`relative transform overflow-hidden rounded-lg bg-white dark:bg-dark-900 text-left shadow-xl transition-all mt-14 lg:mt-0 mx-0 md:mx-6 ${!customSize ? sizeClasses[size] : customSize} overflow-y-auto max-h-dvh`}
                >
                  {/* Modal Content */}
