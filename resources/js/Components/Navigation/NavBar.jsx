...
// AI Gradient Sparkles Icon component
const AISparklesIcon = ({ className, ...props }) => (
...
export default function NavBar({ page }) {
  ...
  const navigation = useMemo(() => [
    ...
    { name: 'Angel Intelligence', href: '/ai-analytics', icon: AISparklesIcon, current: currentPath.startsWith('/ai-analytics'), right: 'pulse_view_administration' },
