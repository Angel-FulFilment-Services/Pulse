...
const QuickActionsWidget = ({ employee }) => {
    ...
    return (
        <DashboardCard title="Quick Actions" className="h-80">
            <div className="grid grid-cols-2 gap-3">
                {quickActions.map((action) => {
                    ...
                    return (
                        <button
                            key={action.id}
                            className="flex flex-col items-center justify-center p-4 border-2 border-dashed border-gray-200 dark:border-dark-600 rounded-lg hover:border-theme-300 dark:hover:border-theme-700 hover:bg-theme-50 dark:hover:bg-theme-900/20 transition-colors"
