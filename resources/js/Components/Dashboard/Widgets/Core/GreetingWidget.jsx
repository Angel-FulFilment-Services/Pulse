...
const GreetingWidget = ({ employee, userStates, isPreview = false }) => {
    ...
    const getCurrentHour = () => {
        return currentRealTime.getHours() + (currentRealTime.getMinutes() / 60);
    };
    ...
    const lightingPosition = useMemo(() => {
        const hour = currentRealTime.getHours() + (currentRealTime.getMinutes() / 60);
    ...
    const getTimeOfDayBackground = () => {
        ...
        const timeStops = [
            ...
            // Morning to midday
            { time: 8.5, from: { r: 147, g: 197, b: 253 }, via: { r: 56, g: 189, b: 248 }, to: { r: 103, g: 232, b: 249 } },
            
            // Hold midday blue longer
            { time: 17, from: { r: 147, g: 197, b: 253 }, via: { r: 56, g: 189, b: 248 }, to: { r: 103, g: 232, b: 249 } },

            // Midday to afternoon
            { time: 18, from: { r: 253, g: 224, b: 71 }, via: { r: 253, g: 186, b: 116 }, to: { r: 251, g: 191, b: 36 } },
            
            // Afternoon to evening (starts later)
            { time: 19, from: { r: 251, g: 146, b: 60 }, via: { r: 248, g: 113, b: 113 }, to: { r: 236, g: 72, b: 153 } },
            { time: 20.5, from: { r: 220, g: 38, b: 127 }, via: { r: 147, g: 51, b: 234 }, to: { r: 67, g: 56, b: 202 } },
    ...
    return (
        <div className="relative rounded-2xl shadow-lg h-40 overflow-hidden">
            ...
            {/* Smoked Glass Overlay - darkens background like tinted glass */}
            <div className="absolute inset-0 pointer-events-none rounded-2xl overflow-hidden">
                ...
                >
                    {/* Glass reflection highlight - more visible */}
                    <div 
                        className="absolute top-0 left-0 w-full h-1/4 rounded-t-2xl"
                        style={{
                            background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.18) 0%, rgba(255, 255, 255, 0.08) 50%, rgba(255, 255, 255, 0.02) 80%, transparent 100%)'
                        }}
                    />
                    
                    {/* Left edge reflection - more prominent */}
                    <div 
                        className="absolute top-0 left-0 w-0.5 h-full rounded-l-2xl"
                        style={{
                            background: 'linear-gradient(180deg, rgba(255, 255, 255, 0.25) 0%, rgba(255, 255, 255, 0.12) 40%, rgba(255, 255, 255, 0.06) 70%, transparent 100%)'
                        }}
                    />
                    
                    {/* Top-right corner reflection */}
                    <div 
                        className="absolute top-0 right-0 w-1/3 h-1/6 rounded-tr-2xl"
                        style={{
                            background: 'radial-gradient(ellipse at top right, rgba(255, 255, 255, 0.12) 0%, rgba(255, 255, 255, 0.04) 50%, transparent 70%)'
                        }}
                    />
                </div>
            </div>
            ...
            {/* Content */}
            <div className="relative z-10 px-6 py-2 h-full flex">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center">
                                {getTimeIcon()}
                                <span className="text-white/90 text-base font-medium">{currentTime}</span>
                            </div>
                        </div>
                    </div>
